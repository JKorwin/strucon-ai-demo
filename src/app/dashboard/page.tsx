    ...
    <>
      ...
      <SignedIn>
        <div className="flex h-screen text-lg">
          {/* Chat Section */}
          <main className="flex flex-col justify-start items-center flex-grow px-6 py-4 bg-white dark:bg-gray-900 text-base w-full relative">
            <h1 className="text-2xl font-bold mb-4 text-center text-gray-900 dark:text-white">Ask Foreman</h1>
            <div ref={chatContainerRef} className="flex-grow overflow-y-auto w-full flex justify-center">
            ...
            <div className="fixed bottom-0 left-0 right-64 bg-white dark:bg-gray-900 p-4 border-t border-gray-300 dark:border-gray-700">
