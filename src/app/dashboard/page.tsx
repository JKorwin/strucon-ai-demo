    ...
    <>
      ...
      <SignedIn>
        <div className="flex h-screen text-lg">
          ...
          {/* Chat */}
          <main className="flex flex-col flex-grow p-6 bg-white dark:bg-gray-950 max-w-4xl w-full mx-auto text-base">
            ...
            <div className="flex-grow overflow-y-auto border rounded-md p-4 bg-gray-50 dark:bg-gray-800 space-y-4">
              {chatLog.map((msg, idx) => (
                <div
                  key={idx}
                  className={`max-w-fit px-4 py-2 rounded-lg break-words whitespace-pre-wrap text-sm leading-relaxed ${
                    msg.role === 'user'
              ...
              {chatLoading && <div className="text-sm text-gray-500">Foreman is thinking…</div>}
            </div>
